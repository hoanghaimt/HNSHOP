...
<html lang="en">
  <head>
    ...
    <title>
        <?php 
            if(isset($title))
                ...
                echo "HNSHOP - Shop Quần Áo Thời Trang Đẹp Tp.HCM";
        ?>
    </title>
    <link rel="icon" type="image/x-icon" href="public/images/logoHN.png">
    ...
    <body >
        ...
        <div class='scrolltop'>
        <div class='scroll icon' style="z-index: 99999"><i class="fa fa-chevron-circle-up"></i></div>
        </div>
