    ...
    <div class="container">
        <div class="col-md-12">
                            ...
                            <tbody>
                                   <tr>
                                    ...
                                    <div class="error" id="result_coupon"></div>
                                     ...
                                     <td colspan="1">
                                    <p class="check-coupon" title="mã giảm giá" onclick="checkCoupon()" style="width: 70px;color: red;font-weight: bold;border-radius: 5px;background: #F6E3CE">Kiểm tra</p>
                                </td>
                                </tr>
                                <tr>
            ...
            <div class="col-xs-12 col-sm-12 col-md-4 products-detail">
                <div class="no-margin-table col-login-checkout" style="width: 95%;float: right;">
