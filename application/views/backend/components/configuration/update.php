							...
							<div class="box-body">
								<div class="col-md-9">
									...
									<div class="form-group">
										...
										<div class="error"><?php echo form_error('mail_smtp')?></div>
									...
									<div class="form-group">
										...
										<div class="error"><?php echo form_error('mail_smtp_password')?></div>
									</div>
									<div class="form-group">
										...
										<div class="error"><?php echo form_error('mail_noreply')?></div>
									</div>
									<div class="form-group">
										...
										<div class="error"><?php echo form_error('priceShip')?></div>
									</div>
									<div class="form-group">
