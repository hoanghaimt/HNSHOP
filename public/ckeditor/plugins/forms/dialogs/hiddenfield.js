...
CKEDITOR.dialog.add("hiddenfield", function(d) {
    return {
        ...
        minWidth: 350,
        minHeight: 110,
        onShow: function() { delete this.hiddenField; var a = this.getParentEditor(),
                b = a.getSelection(),
        ...
        onOk: function() {
            var a = this.getValueOf("info", "_cke_saved_name"),
                ...
                a = CKEDITOR.env.ie && 8 > CKEDITOR.document.$.documentMode ? b.document.createElement('\x3cinput name\x3d"' + CKEDITOR.tools.htmlEncode(a) + '"\x3e') : b.document.createElement("input");
        ...
        contents: [{
            ...
            elements: [{
                ...
                commit: function(a) { this.getValue() ? a.setAttribute("name", this.getValue()) : a.removeAttribute("name") }
