...
CKEDITOR.dialog.add("button", function(b) {
    function d(a) { var b = this.getValue();
    ...
    return {
        ...
        onOk: function() { var a = this.getParentEditor(),
            ...
            this.commitContent(c); var e = new CKEDITOR.htmlParser.basicWriter;
            c.writeHtml(e);
        ...
        contents: [{
            ...
            elements: [{
                ...
                commit: d
            }, { id: "value", type: "text", label: b.lang.forms.button.text, accessKey: "V", "default": "", setup: function(a) { this.setValue(a.getAttribute("value") || "") }, commit: d }, {
                id: "type",
                type: "select",
