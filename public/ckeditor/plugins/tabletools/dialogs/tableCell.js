...
CKEDITOR.dialog.add("cellProperties", function(f) {
    function h(a) { return { isSpacer: !0, type: "html", html: "\x26nbsp;", requiredContent: a ? a : void 0 } }

    function q() { return { type: "vbox", padding: 0, children: [] } }

    function e(a) { return function(b) { for (var k = a(b[0]), c = 1; c < b.length; c++)
                if (a(b[c]) !== k) { k = null; break }
                "undefined" != typeof k && (this.setValue(k), CKEDITOR.env.gecko && "select" == this.type && !k && (this.getInputElement().$.selectedIndex = -1)) } }

    function r(a) { if (a = u.exec(a.getStyle("width") || a.getAttribute("width"))) return a[2] }
    var l = f.lang.table,
        c = l.cell,
        d = f.lang.common,
        ...
        d = [{
            ...
            children: [{
                ...
                onLoad: function() { var a = this.getDialog().getContentElement("info", "widthType").getElement(),
                        b = this.getInputElement(),
                        c = b.getAttribute("aria-labelledby");
                    b.setAttribute("aria-labelledby", [c, a.$.id].join(" ")) },
                setup: e(function(a) { var b = parseInt(a.getAttribute("width"), 10);
                    a = parseInt(a.getStyle("width"), 10); return isNaN(a) ? isNaN(b) ? "" : b : a }),
                ...
                "default": ""
            }, { type: "select", id: "widthType", label: f.lang.table.widthUnit, labelStyle: "visibility:hidden", "default": "px", items: [
                    [l.widthPx, "px"],
                    [l.widthPc, "%"]
                ], setup: e(r) }]
        }, {
            ...
            }, { id: "htmlHeightType", type: "html", html: "", style: "display: none" }]
            ...
            commit: function(a) { var b = this.getValue();
        ...
        }, h(["td{text-align}", "td{vertical-align}"]), { type: "select", id: "cellType", requiredContent: "th", label: c.cellType, "default": "td", items: [
                [c.data, "td"],
                [c.header, "th"]
            ], setup: e(function(a) { return a.getName() }), commit: function(a) { a.renameNode(this.getValue()) } }, h("th"), {
            type: "text",
            id: "rowSpan",
            ...
            setup: e(function(a) { if ((a = parseInt(a.getAttribute("rowSpan"), 10)) && 1 != a) return a }),
            commit: function(a) { var b = parseInt(this.getValue(), 10);
            ...
            setup: e(function(a) { if ((a = parseInt(a.getAttribute("colSpan"), 10)) && 1 != a) return a }),
            commit: function(a) {
            ...
            children: function() {
                var a = [{
                    ...
                    label: c.bgColor,
                    "default": "",
                    setup: e(function(a) { var c = a.getAttribute("bgColor"); return a.getStyle("background-color") || c }),
                    commit: function(a) {
                        this.getValue() ? a.setStyle("background-color", this.getValue()) : a.removeStyle("background-color");
                        a.removeAttribute("bgColor")
                    }
                }];
                n && a.push({ type: "button", id: "bgColorChoose", "class": "colorChooser", label: c.chooseColor, onLoad: function() { this.getElement().getParent().setStyle("vertical-align", "bottom") }, onClick: function() { f.getColorFromDialog(function(a) { a && this.getDialog().getContentElement("info", "bgColor").setValue(a);
                            this.focus() }, this) } });
                return a
            }()
        }, {
            ...
            children: function() {
                var a = [{
                    ...
                    label: c.borderColor,
                    "default": "",
                    setup: e(function(a) { var c = a.getAttribute("borderColor"); return a.getStyle("border-color") || c }),
                    commit: function(a) { this.getValue() ? a.setStyle("border-color", this.getValue()) : a.removeStyle("border-color");
                ...
                n && a.push({
                    ...
                    onLoad: function() { this.getElement().getParent().setStyle("vertical-align", "bottom") },
                    onClick: function() {
        ...
        t = -1,
        g = [q()],
        d = CKEDITOR.tools.array.filter(d, function(a) { var b = a.requiredContent;
            delete a.requiredContent;
            (b = f.filter.check(b)) && !a.isSpacer && p++; return b });
    5 < p && (g = g.concat([h(), q()]));
    CKEDITOR.tools.array.forEach(d, function(a) { a.isSpacer || t++;
    ...
    return {
        ...
        minHeight: 50,
        contents: [{ id: "info", label: c.title, accessKey: "I", elements: [{ type: "hbox", widths: 1 === g.length ? ["100%"] : ["40%", "5%", "40%"], children: g }] }],
