...
CKEDITOR.plugins.setLang("a11yhelp", "et", {
    ...
    legend: [{
        ...
        name: "Käsud",
        items: [{ name: "Tühista käsk", legend: "Press ${undo}" }, { name: " Redo command", legend: "Press ${redo}" }, { name: " Bold command", legend: "Press ${bold}" }, { name: " Italic command", legend: "Press ${italic}" }, {
            ...
            { name: " Accessibility Help", legend: "Press ${a11yHelp}" }, { name: "Asetamine tavalise tekstina", legend: "Press ${pastetext}", legendEdge: "Press ${pastetext}, followed by ${paste}" }
        ]
    }],
    tab: "Tab",
    pause: "Paus",
